...
def teleop_loop(
    ...
    Args:
        ...
        keyboard: Optional keyboard teleop for mobile-base robots (xlerobot / lekiwi).
    """
    ...
    while True:
        ...
        # Get teleop action (optional keyboard for mobile base: xlerobot / lekiwi / …)
        ...
        if keyboard is not None and hasattr(robot, "_from_keyboard_to_base_action"):
            ...
            raw_action = {**raw_action, **base_action}
...
def teleoperate(cfg: TeleoperateConfig):
    ...
    # Mobile bases (xlerobot / bi_xlerobot / lekiwi): arm teleop + keyboard for wheels.
    keyboard = None
    if hasattr(robot, "_from_keyboard_to_base_action"):
        ...
        logging.info(
            "Keyboard base control enabled: forward=%s backward=%s rotate_left=%s "
